...
gulp.task('html-horizontal-templates', function () {
    var options = {
        root: '/pentaho/plugin/pentaho-cdf-dd/api/resources/system/osha-dvt-esener/static/custom/modules/horizontal/',
...
gulp.task('html-vertical-templates', function () {
    var options = {
        root: '/pentaho/plugin/pentaho-cdf-dd/api/resources/system/osha-dvt-esener/static/custom/modules/vertical/',
        module: '',
        filename: "templates.js",
        htmlmin: true,
        templateHeader: "define(function (require) { 'use strict'; var angular = require('common-ui/angular');",
        templateBody: "angular.module('"
        + "<%= url.replace('/pentaho/plugin/pentaho-cdf-dd/api/resources/system/osha-dvt-esener/static/custom/modules/vertical/','').replace(/\\/(.*?).html/g, '') %>'"
