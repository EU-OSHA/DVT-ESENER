    ...
    function DvtRadarDirective( $q, $log, dvtUtils, plotsProvider, exportService, dataService, maximize) {
        ...
        if (msie > 0 || !!navigator.userAgent.match(/Trident.*rv\:11\./)) {
         template='<div class="col-md-12 dvt-chart radar">'
             ...
             + '<img alt="Maximize graphic" data-ng-click="open(items[0].action)" title="Maximize graphic" src="/pentaho/plugin/pentaho-cdf-dd/api/resources/system/osha-dvt-esener/static/custom/img/more.png"/>'
             + '</div>'
             + '</div>'
             +'<div class="col-xs-12">'
           ...
           // if(!configService.isMobile()) {
                template += '<img alt="Maximize graphic" data-ng-click="open(items[0].action)" title="Maximize graphic" src="/pentaho/plugin/pentaho-cdf-dd/api/resources/system/osha-dvt-esener/static/custom/img/more.png"/>';
          //  }
