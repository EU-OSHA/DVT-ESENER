...
define(function (require) {
    ...
    function DvtBarChartDirective(dataService, $log, plotsProvider, exportService, dvtUtils, maximize) {
       ...
       // if(!configService.isMobile()) {
            _template += '<img alt="Maximize graphic" data-ng-click="open(items[0].action)" title="Maximize graphic" src="/pentaho/plugin/pentaho-cdf-dd/api/resources/system/osha-dvt-esener/static/custom/img/more.png"/>';
       // }
        ...
        _template+= '</div>'
            ...
            + '</div>'
            + '<div class="logoGraphics-wrapper"><img alt="European Agency for Safety and Health at Work" src="/pentaho/plugin/pentaho-cdf-dd/api/resources/system/osha-dvt-esener/static/custom/img/EU-OSHA-en.png" class="logoGraphics"></div>'
        ...
        _template+='</div>'
            ...
            + '</div>'
            + '</div>'
            + '<div class="logoGraphics-wrapper"><img alt="European Agency for Safety and Health at Work" src="/pentaho/plugin/pentaho-cdf-dd/api/resources/system/osha-dvt-esener/static/custom/img/EU-OSHA-trans-en.png" class="logoGraphics"></div>'
            + '<div class="functionalLegend" data-ng-bind-html="functionalLegend"></div>'
            + '</div>'
