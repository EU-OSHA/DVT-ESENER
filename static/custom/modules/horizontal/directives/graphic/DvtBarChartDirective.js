...
*/
            ...
            _template += '<div data-ng-if="!isMaximized && haveEnlarge" class="pull-right contextual-menu cursor-pointer maximizeImage">';
                ...
                _template+='<img alt="Maximize graphic" data-ng-click="open(items[1].action)" title="Maximize graphic" src="/pentaho/plugin/pentaho-cdf-dd/api/resources/system/osha-dvt-esener/static/custom/img/more.png"/>';
                _template 
     ...
     //   }
        ...
        //    + '<div class="legend-info" ng-if="isMaximized && legendClickMode">Click on each value on the legend to hide/show in on the chart</div>'
           ...
           // + '<div class="logoGraphics-wrapper"><img alt="European Agency for Safety and Health at Work" src="/pentaho/plugin/pentaho-cdf-dd/api/resources/system/osha-dvt-esener/static/custom/img/osha-logo.svg" class="logoGraphics"></div>'
            ...
            link: function (scope, element, attributes, controllers) {
                ...
                var definition = {
                    ...
                    chartDefinition: {
                        ...
                        path: attributes.cda || "osha-dvt-esener/dashboards/esenerdash.cda",
